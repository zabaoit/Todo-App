    ...
    <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl p-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg bg-gradient-to-r from-green-600 to-emerald-600 text-white py-3 px-4 rounded-lg flex items-center justify-center gap-2 hover:from-green-500 hover:to-emerald-500 transition cursor-pointer">
